...
| 019 | ツール | オーバーレイ動画MP4背景対応 | **完了** | 中 | [019_overlay_video_background](019_overlay_video_background/) |
...
| 2026-03-29 | **019クローズ**。pose_overlay_videoの-bオプションをMP4動画対応に拡張。FPS自動取得・フレーム数不一致警告を実装。実機確認OK |
